...
sprites.onCreated(SpriteKind.SUPER_HEART, function (sprite) {
    music.pewPew.play()
})
...
sprites.onCreated(SpriteKind.STRONG_KNIFE, function (sprite) {
    music.pewPew.play()
})
sprites.onCreated(SpriteKind.turrent, function (sprite) {
    music.pewPew.play()
})
...
sprites.onCreated(SpriteKind.HEALTH, function (sprite) {
    music.pewPew.play()
})
...
sprites.onCreated(SpriteKind.FAST_BOI, function (sprite) {
    music.pewPew.play()
})
